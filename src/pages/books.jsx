  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] px-6 py-10 ">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-[#572C10] mt-4 text-2xl font-semibold">
      ...
      <div className="max-w-6xl mx-auto bg-white p-6 rounded-2xl shadow-md">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-5">
          ...
          <button
            ...
            className="bg-[#572C10] hover:bg-[#3d1f0a] text-white text-2xl px-8 py-3 rounded-xl font-semibold transition"
          >
            Search
          </button>
      ...
      <div className="flex justify-center gap-4 mt-12 pb-10">
        ...
        {/* VIEW MORE */}
        <button
          className="bg-[#572C10] hover:bg-[#3d1f0a] text-white px-8 py-3 rounded-xl text-2xl shadow-md transition"
        >
          View More
        </button>
